...
/**
 * This is an internal method not meant for general use. The only reason to have this
...
class OtlpStepTuple2<T1, T2> extends StepTuple2<T1, T2> {
    ...
    public OtlpStepTuple2(Clock clock, long stepMillis, T1 t1NoValue, T2 t2NoValue, Supplier<T1> t1Supplier,
